...
class ChauffeurDrivenOutStation(db.Model):
    __tablename__ = 'chauffeur_driven_outstation'
    id = db.Column(db.Integer, primary_key = True, autoincrement = True)
    car_id = db.Column(db.Integer,nullable = False )
    car_type = db.Column(db.Enum('Chauffeur_Driven_OutStation') , nullable = False)
...
class ChauffeurDrivenOutStationSchema(ma.SQLAlchemyAutoSchema):
    class Meta:
        model = ChauffeurDrivenOutStation